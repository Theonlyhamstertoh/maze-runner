...
export default function Flag({ position, wallColor }) {
  const group = useRef();
  const { nodes, materials } = useGLTF(
    "https://vazxmixjsiawhamofees.supabase.co/storage/v1/object/public/models/flag/model.gltf"
  );
  return (
    <group position={[position.x, -0.5, position.z]} ref={group} dispose={null}>
      <group rotation={[Math.PI / 2, 0, Math.PI * 2 * Math.random()]}>
        <mesh
